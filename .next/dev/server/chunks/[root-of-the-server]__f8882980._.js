...
async function POST(request) {
    try {
        ...
        const audit = {
            audit_id: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mockAuditStore"].nextAuditId++,
            audit_name,
            location,
            audit_date: new Date().toISOString(),
            devices: devices.map((d)=>({
                    ...d,
                    daily_kwh_total: d.power_rating_watts * d.quantity * d.hours_per_day / 1000
                }))
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mockAuditStore"].audits.push(audit);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8882980._.js.map